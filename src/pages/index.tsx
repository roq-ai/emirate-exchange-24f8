...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Emirate Exchange`}</title>

        <meta
          name="description"
          content="Emirate Exchange: Unifying your processes into one easy-to-use system. Offering powerful and flexible cloud-based solutions for your business, wherever you are on your digital transformation journey."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1671726203454-5d7a5370a9f4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MXwxfHNlYXJjaHwxfHx0ZWNobm9sb2d5fGVufDB8fHx8MTY5ODIzODA5M3ww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@surface?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Surface`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Emirate Exchange: Unifying your processes into one easy-to-use system. Offering powerful and flexible cloud-based solutions for your business, wherever you are on your digital transformation journey.`}
            </Text>
            <Box
