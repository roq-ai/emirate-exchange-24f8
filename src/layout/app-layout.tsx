...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'team-member', 'it-administrator', 'project-manager'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Businesses', path: '/businesses', entity: 'business', service: AccessServiceEnum.PROJECT, icon: FiHome },
    {
      name: 'It Administrators',
      path: '/it-administrators',
      entity: 'it_administrator',
      service: AccessServiceEnum.PROJECT,
      icon: FiSettings,
    },
    { name: 'Projects', path: '/projects', entity: 'project', service: AccessServiceEnum.PROJECT, icon: FiBriefcase },
    {
      name: 'Team Members',
      path: '/team-members',
      entity: 'team_member',
